...
//P
//1. loop through
//2. if num is not only +1 from prior num stop array 
...
//could not figure P2 so saw the solution. 
//arr[i] + 1 !== arr [ i+1 ] is a bit confusing to see at first but Now I understand.
